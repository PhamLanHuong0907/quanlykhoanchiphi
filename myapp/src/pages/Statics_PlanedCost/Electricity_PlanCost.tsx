...
const Electricity_PlanCost: React.FC = () => {
  const columns = [
    "STT",
    "Mã chi phí điện năng kế hoạch",
    "Xem",
    "Sửa",
  ];
  ...
  return (
    <Layout>
      <div className="p-6">
        <AdvancedTable
          title01="Thống kê vận hành  /  Chi phí kế hoạch  /  Chi phí điện năng kế hoạch"
...
export default Electricity_PlanCost;
