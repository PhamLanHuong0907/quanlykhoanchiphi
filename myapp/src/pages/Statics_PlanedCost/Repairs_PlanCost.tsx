...
const Repairs_PlanCost: React.FC = () => {
  const columns = [
    "STT",
    "Mã chi phí SCTX kế hoạch",
    "Xem",
    "Sửa",
  ];
  ...
  return (
    <Layout>
      <div className="p-6">
        <AdvancedTable
          title01="Thống kê vận hành  /  Chi phí kế hoạch  /  Chi phí SCTX kế hoạch"
...
export default Repairs_PlanCost;
